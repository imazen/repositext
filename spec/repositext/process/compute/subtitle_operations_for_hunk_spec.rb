  ...
  class Process
    class Compute
      ...
      describe SubtitleOperationsForHunk do
        ...
        describe '#compute_subtitle_operations_for_sanitized_polgs' do
          ...
          [
            ...
            [
              'Merge combined with removal of two gap_marks',
              %w[@*56* %word1 word2 word3 word4. @%word5 word6 word7 word8, word9 word10 word11 word12 word13 word14 word15 word16 word17 word18 word19 word20 word21, @some more text.],
              %w[@*56*  word1 word2 word3 word4.   word5 word6 word7 word8, word9 word10 word11 word12 word13 word14 word15 word16 word17 word18 word19 word20 word21, @some more text.],
              [
                {
                  :operationId=>"hunk_index-1",
                  ...
                  :afterStid=>nil,
                  :affectedStids=>[
                    { :stid=>"1000000", :before=>"*56* %word1 word2 word3 word4. ", :after=>"*56* word1 word2 word3 word4. word5 word6 word7 word8, word9 word10 word11 word12 word13 word14 word15 word16 word17 word18 word19 word20 word21, " },
                    { :stid=>"1000001", :before=>"%word5 word6 word7 word8, word9 word10 word11 word12 word13 word14 word15 word16 word17 word18 word19 word20 word21, ", :after=>"" }
                  ]
                }
              ]
            ],
