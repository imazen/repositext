...
module Kramdown
  describe TmpEmClassProcessor do

    describe 'recursively_process_temp_em_class!' do

      em1 = ElementRt.new(:em, nil, 'id' => 'em1')
      em2 = ElementRt.new(:em, nil, 'id' => 'em2')
      em_t1 = ElementRt.new(:em, nil, 'class' => 'tmpNoItalics', 'id' => 'em_t1')
      em_t2 = ElementRt.new(:em, nil, 'class' => 'tmpNoItalics', 'id' => 'em_t2')
      em_t3 = ElementRt.new(:em, nil, 'class' => 'tmpNoItalics', 'id' => 'em_t3')
      ...
      text6 = ElementRt.new(:text, "text6")
