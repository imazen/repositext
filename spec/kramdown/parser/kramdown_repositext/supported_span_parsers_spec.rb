    ...
    describe KramdownRepositext do
      describe 'Supported span parsers' do
        ...
        [
          ...
          [:gap_mark, "%", " - :root - {:encoding=>#<Encoding:UTF-8>, :location=>1, :abbrev_defs=>{}}\n   - :p - {:location=>1}\n     - :gap_mark - {:category=>:span, :location=>1}\n"],
          ...
          [:subtitle_mark, "@", " - :root - {:encoding=>#<Encoding:UTF-8>, :location=>1, :abbrev_defs=>{}}\n   - :p - {:location=>1}\n     - :subtitle_mark - {:category=>:span, :location=>1}\n"]
